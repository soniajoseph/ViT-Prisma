'''
Code based on: https://github.com/jbloomAus/SAELens/blob/main/sae_lens/training/sae_trainer.py
'''
...
class SAETrainer:
    ...
    def fit(self) -> TrainingSAE:
        ...
        while self.n_training_tokens < self.cfg.total_training_tokens:
            # Do a training step.
            layer_acts = self.activation_store.next_batch('train')[:, 0, :].to(self.sae.device)
