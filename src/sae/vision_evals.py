...
def run_evals_vision(
    ...
    hook_point_layer = sparse_autoencoder.cfg.hook_layer
    # hook_point_head_index = sparse_autoencoder.cfg.hook_point_head_index

    ### Evals
    dummy = None
    eval_tokens = activation_store.get_batch_tokens(dummy)
    ...
    _, cache = model.run_with_cache(
        eval_tokens,
        names_filter=[hook_point.format(layer=hook_point_layer)],
    )
    ...
    # print(f'{hook_point)
    # print(hook_point_layer)

    # print('hook name', hook_point.format(layer=hook_point_layer))
