...
if __name__ == "__main__":
    ...
    cfg = VisionModelSAERunnerConfig(
        ...
        dataset_path=str(DATA_DIR / "cifar"),
        dataset_train_path=str(DATA_DIR / "cifar"),
        dataset_val_path=str(DATA_DIR / "cifar"),
        log_to_wandb=False,
        wandb_entity="Stevinson",
        wandb_project="cifar-sae",
    ...
    # TODO EdS: Use test data to train the sae
